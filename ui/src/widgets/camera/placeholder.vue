...
v-carousel.carousel(v-model="camera" height="200" hide-delimiters)
  ...
  v-carousel-item(v-for="(placeholder,i) in placeholders" :key="i" reverse-transition="fade-transition" transition="fade-transition")
    .grid-stack-item(:gs-id="placeholder.id" :gs-type="placeholder.type" :gs-w="placeholder.w" :gs-min-w="placeholder.minW" :gs-max-w="placeholder.maxW" :gs-h="placeholder.h" :gs-min-h="placeholder.minH" :gs-max-h="placeholder.maxH" :gs-no-resize="placeholder.disableResize" :gs-no-move="placeholder.disableDrag" :data-camera-name="placeholder.id")
      .grid-stack-item-content
        .content.tw-overflow-hidden.tw-relative
          .widget
          
            .tw-block.prevent-title-navigation
