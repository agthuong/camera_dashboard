...
import * as PrivateKeyMiddleware from '../../middlewares/private.key.middleware.js';
...
export const routesConfig = (app) => {
   ...
   *     security:
   *       - apiKeyAuth: []
   *     summary: Get list of cameras with name and rtsp link
   *     parameters:
   *       - in: header
   *         name: X-API-Key
   *         schema:
  ...
  app.get('/api/cameras/list', [
    PrivateKeyMiddleware.validPrivateKeyNeeded,
    CamerasController.getCamerasList
  ]);
